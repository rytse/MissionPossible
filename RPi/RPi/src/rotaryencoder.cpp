/*! Andrew Stine's wiringPi rotary encoder lib */
...
// TODO make sure this works after I messed with passing ptrs
void setupencoder(struct encoder *enc, int pin_a, int pin_b)
{
